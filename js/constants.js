...
const DEBUG_FARMER = true;        // spawns the farmer 5 units in front of the player (which drops key-hint note)
...
const DEBUG_TALISMAN = true;      // start with talisman already in inventory
